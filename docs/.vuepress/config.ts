...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'westeast/westeast.github.io', // 导航栏右侧生成Github链接
    ...
    blogger: {
      ...
      name: 'Hook Zou',
      slogan: '技术投资界的农民, Stay Hungry, Stay Foolish！',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:westeast@foxmail.com',
        },
        {
    ...
    footer: {
      ...
      copyrightInfo:
        'Westeast | <a href="https://github.com/westeast/westeast.github.io" target="_blank">Blog</a> ', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'Ov23libFcFeZ6erU1de3',
          clientSecret: '85b9354e71afccfb36500c89b26c54c62a091292',
          repo: 'westeast.github.io', // GitHub 仓库
          owner: 'westeast', // GitHub仓库所有者
          admin: ['westeast'], // 对仓库有写权限的人
